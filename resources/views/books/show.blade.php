...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
    ...
    <div style="display:flex; gap:8px;">
        <div style="position:relative; display:inline-block;" class="export-dropdown">
            ...
            <div style="display:none; position:absolute; right:0; top:calc(100% + 4px); background:var(--color-bg-primary); border:1px solid var(--color-border); border-radius:var(--radius-md); padding:4px; z-index:100; min-width:180px; box-shadow:0 10px 25px rgba(0,0,0,0.1);">
                <a href="{{ route('export.book', $book) }}?format=txt" style="display:flex; align-items:center; gap:8px; padding:8px 12px; color:var(--color-text); text-decoration:none; border-radius:var(--radius-sm); font-size:var(--font-size-sm);" onmouseover="this.style.background='var(--color-bg-secondary)'" onmouseout="this.style.background='transparent'">📄 Text (.txt)</a>
                <a href="{{ route('export.book', $book) }}?format=md" style="display:flex; align-items:center; gap:8px; padding:8px 12px; color:var(--color-text); text-decoration:none; border-radius:var(--radius-sm); font-size:var(--font-size-sm);" onmouseover="this.style.background='var(--color-bg-secondary)'" onmouseout="this.style.background='transparent'">📝 Markdown (.md)</a>
                <a href="{{ route('export.book', $book) }}?format=epub" style="display:flex; align-items:center; gap:8px; padding:8px 12px; color:var(--color-accent); font-weight:500; text-decoration:none; border-radius:var(--radius-sm); font-size:var(--font-size-sm);" onmouseover="this.style.background='var(--color-bg-secondary)'" onmouseout="this.style.background='transparent'">📚 eBook (.epub)</a>
                <a href="{{ route('export.book', $book) }}?format=pdf" style="display:flex; align-items:center; gap:8px; padding:8px 12px; color:var(--color-danger); font-weight:500; text-decoration:none; border-radius:var(--radius-sm); font-size:var(--font-size-sm);" onmouseover="this.style.background='var(--color-bg-secondary)'" onmouseout="this.style.background='transparent'">📕 PDF (.pdf)</a>
            </div>
        </div>
